...
import br.unb.cic.sa.model.EnhancedForStatement;;
 ...
 * @author rbonifacio
 */
public class RICVisitor extends Visitor<EnhancedForStatement> {
	...
	public boolean visit(org.eclipse.jdt.core.dom.EnhancedForStatement node) {
		...
		EnhancedForStatement efs = new EnhancedForStatement(file, unit.getLineNumber(node.getStartPosition()),
